...
<!--订单确认-->
<form action="http://localhost:80/yibao/paymentSend.html" method="post" id="pay_form">
    <div id="container" class="clearfix" >
        <!-- 支付订单信息-->
        <div class="pay_info">
            <b>支付金额：<i>10000元</i></b><input type="hidden" name="payment" value="0.01"/>
            <span>支付订单：${orderId} 收款方：商城</span>
